    ...
    <el-card class="box-card">
      ...
      >
        ...
        <el-form-item label="借阅状态" prop="state">
          <el-row>
            <el-col :span="24"> <span>正在归还</span></el-col>
          </el-row>
        </el-form-item>

        <el-form-item label="备注(异常状态请注明)">
...
import { finishBorrow } from "@/network/borrowNetwork";
  ...
  userAccount: [
    {
      type: "email",
      required: true,
      message: "Please input reader account",
      trigger: "blur",
    },
  ],
  bookName: [
